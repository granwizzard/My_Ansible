...
#Variable to catch the Name of the System
$S_Name = "http://"+$env:COMPUTERNAME+":5985/wsman"

#Small test with WinRs
#If you receive an error you forgot to define the username and password
#on This script
winrs -r:$S_Name -u:username -p:yourpass ipconfig
